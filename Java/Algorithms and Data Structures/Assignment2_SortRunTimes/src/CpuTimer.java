...
public class CpuTimer {
	...
	// Thread management bean to access CPU time private final ThreadMXBean bean;
	// Amount of CPU time used before creation of this class private final double startTimeSeconds;
}